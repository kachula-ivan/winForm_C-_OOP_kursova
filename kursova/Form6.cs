...
namespace kursova
{
    public partial class Form6 : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "bdDataSet2.Назва_авто". При необходимости она может быть перемещена или удалена.
            this.назва_автоTableAdapter.Fill(this.bdDataSet2.Назва_авто);
        }
        ...
        {
            назва_автоTableAdapter.Update(bdDataSet2.Назва_авто);
        }
